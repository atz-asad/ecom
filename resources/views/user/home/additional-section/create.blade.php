...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="separator"><i class="flaticon-right-arrow"></i></li>
      <li class="nav-item"><a href="#">{{ __('Add Section') }}</a></li>
    </ul>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header additional-card-header">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 m-auto">
              ...
              <form id="pageForm" action="{{ route('user.additional_section.store') }}" method="POST">
                @csrf
                  ...
                  <div class="col-lg-6">
                    <div class="form-group p-0">
                      ...
                      <select name="position" class="form-control select2">
                        ...
                        <option value="hero_section">{{ $keywords['After Hero Section'] ?? __('After Hero Section') }}
                        </option>
