...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('user.home_page.hero.slider_version') . '?language=' . request()->input('language') }}">{{ __('Sliders') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="btn_name"
                        placeholder="{{ __('Enter Slider Button Name') }}" value="{{ $slider->btn_name }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="url" class="form-control" name="video_url"
                          placeholder="{{ __('Enter Video URL') }}" value="{{ $slider->video_url }}">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="video_button_text"
                          placeholder="{{ __('Enter Video Button Text') }}" value="{{ $slider->video_button_text }}">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="serial_number"
                        placeholder="{{ __('Enter Slider Serial Number') }}" value="{{ $slider->serial_number }}">
